...
/** @brief Ocland event abstraction entity construction.
 *
 * This method is used for the events generated by the OpenCL API.
 *
 * @param v Client validator which this event is belonging to.
 * @param event Event generated by the OpenCL API.
 * @param event_on_peer Reference to the remote object.
 * @param errcode_ret CL_SUCCESS if the event has been right generated, the
 * appropiate error code otherwise.
 */
